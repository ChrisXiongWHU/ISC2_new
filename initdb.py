...
from duos.models import Account,Application,User,createRandomFields,Device
...
if __name__ == '__main__':
    ...
    **Account.new_account_hostname())
    ...
    # user3 = User.objects.create(user_name="xrb_chris_acc",user_phone="15927432501",account=acc1)
